          ...
          <div class="row">
           <div class="col-md-12">
            ...
            @forelse($forums as $forum)
               <tr>
                <td>{{$forum->title}}.., <i style="font-size: 10px; color: #999;"> {{$forum->created_at->diffForHumans()}} min ago, {{$forum->comments->count()}} Comments, {{$forum->getPageViews()}} Views</i>
                 </td>
                ...
                @endif
                <td width="10"><a href="{{url('forum/read'.'/'.$forum->slug.'/'.$role_id)}}" class="btn btn-sm btn-info"><i class="fa fa-eye"></i> View</a></td>
              </tr>
              @empty
              <div class="text-center">
              tidak ada postingan
